...
const publicPaths = ["/login", "/register", "/forgot-password", "/reset-password", "/api/auth/login", "/api/auth/register", "/api/auth/forgot-password", "/api/auth/reset-password", "/api/slack/callback", "/api/slack/command", "/api/slack/interactions", "/api/widget", "/widget"];
